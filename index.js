      ...
      >
        <View style={[styles.container, { ...modalStyleProps }]}>
          <TouchableOpacity
            ...
            activeOpacity={1}
            onPress={this.props.cancelable ? this.handleOnCloseDialog : () => null}
          >
            <View style={[styles.modal_container, { ...dialogStyleProps }]}>
              <View style={styles.modal_body}>
                ...
                <TextInput
                  ...
                  testID={(textProps && textProps.testID) ? textProps.testID : 'react-native-dialog-input/textInput'}
                  ...
                  returnKeyType={(textProps && textProps.returnKeyType) ? textProps.returnKeyType : 'done'}
                  autoFocus
                  ...
                  onSubmitEditing={this.state.inputModal ? this.handleSubmit : () => null}
                  value={value}
                />
              </View>
